...
import com.atalaykaan.e_commerce_backend.domain.auth.filter.JwtAuthFilter;
                ...
                .authorizeHttpRequests(
                        request ->
                                request
                                        ...
                                        .requestMatchers(HttpMethod.GET, API_PREFIX + API_VERSION + API_PRODUCTS + "/*").hasRole("USER")
                                        .requestMatchers(HttpMethod.GET, API_PREFIX + API_VERSION + API_PRODUCTS + "/search").hasRole("USER")
                                        ...
                                        .requestMatchers(HttpMethod.GET, API_PREFIX + API_VERSION + API_PAYMENTS).hasRole("USER")
